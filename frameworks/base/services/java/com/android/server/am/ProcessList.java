...
class ProcessList {
    ...
    static int HIDDEN_APP_MIN_ADJ = 12; //9
    ...
    static final int BACKUP_APP_ADJ = 10; //4
    ...
    static final int PERCEPTIBLE_APP_ADJ = 6; //2

    // This is a process only hosting activities that are visible to the
    // user, so we'd prefer they don't disappear.
    static final int VISIBLE_APP_ADJ = 3; //1
    ...
    static final int MIN_HIDDEN_APPS = 0; //2
    ...
    static final long[] mOomMinFreeHigh = new long[] {
            32768, 40960, 49152,
            57344, 65536, 81920
    };
    ...
    static final long[] mOomMinFree = new long[mOomAdj.length];

    // reintroduce settings of OOM adj and lowmem values via properties
    static final long[] myOomMinFree = new long[] {
            2560, 4096, 8192,
            18944, 22016, 76800
    };
    ...
    private void updateOomLevels(int displayWidth, int displayHeight, boolean write) {
        ...
        for (int i=0; i<mOomAdj.length; i++) {
            ...
            memString.append(myOomMinFree[i]);
        }
